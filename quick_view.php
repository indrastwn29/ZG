   ...
   <form action="" method="post" class="box">
      ...
      <div class="row">
         ...
         <div class="content">
            ...
            <div class="flex">
               <div class="price"><span>Rp</span><?= number_format($fetch_product['price'], 2); ?><span>/-</span></div>
               <?php if ($fetch_product['price'] > 0) { ?>
                  <input type="number" name="qty" class="qty" min="1" max="<?= $fetch_product['price']; ?>" value="1">
               <?php } else { ?>
                  <input type="number" name="qty" class="qty" min="1" max="0" value="0" disabled>
               <?php } ?>
            </div>
            <div class="details"><?= $fetch_product['details']; ?></div>
            <div class="flex-btn">
               <?php if ($fetch_product['details'] > 0) { ?>
